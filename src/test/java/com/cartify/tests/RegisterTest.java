...
public class RegisterTest extends BaseTest {
    ...
    public void testValidRegistration() {
        ...
        registerPage.fillDate("01/01/2000"); // Date is between Name and Phone in UI, but order here is fine if locators
                                             // work
        ...
        Assert.assertFalse(driver.getCurrentUrl().contains("register.html"),
                "User should be redirected after registration");
    }
    ...
    public void testAddressSubmission() {
        ...
        // Assert success
        Assert.assertFalse(driver.getCurrentUrl().contains("register.html"),
                "User should be redirected after submitting address");
    }
    ...
    public void testPasswordMinLength() {
        ...
        Assert.assertNotNull(error, "Error message should be displayed for short password");
        Assert.assertTrue(error.contains("Password must be 8+ chars"), "Error message should match expected text");
    }
}
